...
export const LOCAL_PRACTICE_TESTS: PracticeTestMeta[] = [
  ...
  { id: "ssat-middle-sample", label: "SSAT Middle Sample", examFamily: "SSAT", region: "US", durationMinutes: 60, sectionCount: 2 },
  { id: "ssat-upper-sample", label: "SSAT Upper Sample", examFamily: "SSAT", region: "US", durationMinutes: 75, sectionCount: 2 },
...
const BANKS: Record<string, BankItem[]> = {
  ...
  "ssat-middle-sample": [
    { id: "ss-m1", prompt: "If 2x + 5 = 17, what is x?", choices: ["4", "6", "11", "22"], correctIndex: 1, skillTag: "algebra" },
    { id: "ss-m2", prompt: "What is 25% of 80?", choices: ["15", "20", "25", "40"], correctIndex: 1, skillTag: "percent" },
    { id: "ss-m3", prompt: "BOOK is to READING as FORK is to:", choices: ["Kitchen", "Eating", "Spoon", "Food"], correctIndex: 1, skillTag: "analogies" },
    { id: "ss-m4", prompt: "The median of 3, 7, 7, 12 is:", choices: ["3", "7", "9", "12"], correctIndex: 1, skillTag: "statistics" },
    { id: "ss-m5", prompt: "'Brief' most nearly means:", choices: ["Long", "Short", "Angry", "Bright"], correctIndex: 1, skillTag: "vocabulary" },
  ],
  "ssat-upper-sample": [
    { id: "ss-u1", prompt: "If 3x - 4 = 11, what is x?", choices: ["3", "5", "7", "15"], correctIndex: 1, skillTag: "algebra" },
    { id: "ss-u2", prompt: "A line has slope -2 and y-intercept 5. Its equation is:", choices: ["y = -2x + 5", "y = 2x + 5", "y = -2x - 5", "y = x/2 + 5"], correctIndex: 0, skillTag: "algebra" },
    { id: "ss-u3", prompt: "HOT is to COLD as NORTH is to:", choices: ["East", "South", "West", "Polar"], correctIndex: 1, skillTag: "analogies" },
    { id: "ss-u4", prompt: "If |x - 6| = 2, x could be:", choices: ["4 only", "8 only", "4 or 8", "-4 or 8"], correctIndex: 2, skillTag: "algebra" },
    { id: "ss-u5", prompt: "'Ambivalent' most nearly means:", choices: ["Certain", "Mixed feelings", "Hostile", "Silent"], correctIndex: 1, skillTag: "vocabulary" },
  ],
  "nz-ncea-l1": [
