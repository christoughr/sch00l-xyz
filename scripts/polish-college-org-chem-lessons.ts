...
import {
  ...
  isPublisherLesson,
  type LessonRow,
} from "../src/lib/college-org-chem-lesson-polish";
...
async function main() {
  ...
  if (!units?.length) {
    console.error("Run scripts/seed-college-org-chem.mjs first");
    process.exit(1);
  }
  ...
  console.log("Done — https://sch00l.ai/study → Organic Chemistry");
}
