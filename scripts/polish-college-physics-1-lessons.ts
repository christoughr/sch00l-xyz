...
import {
  ...
  isPublisherLesson,
  type LessonRow,
} from "../src/lib/college-physics-1-lesson-polish";
...
async function main() {
  ...
  if (!units?.length) {
    console.error("Run scripts/seed-college-physics-1.mjs first");
    process.exit(1);
  }
  ...
  console.log("Done — https://sch00l.ai/study → Physics I");
}
