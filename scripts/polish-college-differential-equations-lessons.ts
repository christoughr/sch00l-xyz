...
import {
  ...
  isPublisherLesson,
  type LessonRow,
} from "../src/lib/college-differential-equations-lesson-polish";
...
async function main() {
  ...
  if (!units?.length) {
    console.error("Run scripts/seed-college-differential-equations.mjs first");
    process.exit(1);
  }
  ...
  console.log("Done — https://sch00l.ai/study → Differential Equations");
}
