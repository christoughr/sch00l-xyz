...
import {
  ...
  isPublisherLesson,
  type LessonRow,
} from "../src/lib/college-stats-intro-lesson-polish";
...
async function main() {
  ...
  if (!units?.length) {
    console.error("Run scripts/seed-college-stats-intro.mjs first");
    process.exit(1);
  }
  ...
  console.log("Done — https://sch00l.ai/study → Introductory Statistics");
}
