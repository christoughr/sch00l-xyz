#!/usr/bin/env npx tsx
/** npx tsx scripts/polish-act-science-lessons.ts — after ACT Science publish */
import fs from "fs";
...
import {
  ...
  isPublisherLesson,
  type LessonRow,
} from "../src/lib/act-science-lesson-polish";
...
async function main() {
  ...
  if (!units?.length) {
    console.error("Run seed-act-science.mjs first");
    process.exit(1);
  }
  ...
  console.log("Done — https://sch00l.ai/study → ACT Science");
}
