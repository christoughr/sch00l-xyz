...
import {
  ...
  isPublisherLesson,
  type LessonRow,
} from "../src/lib/college-discrete-math-lesson-polish";
...
async function main() {
  ...
  if (!units?.length) {
    console.error("Run scripts/seed-college-discrete-math.mjs first");
    process.exit(1);
  }
  ...
  console.log("Done — https://sch00l.ai/study → Discrete Mathematics");
}
