#!/usr/bin/env npx tsx
/** npx tsx scripts/polish-act-english-lessons.ts — after ACT English publish */
import fs from "fs";
...
import {
  ...
  isPublisherLesson,
  type LessonRow,
} from "../src/lib/act-english-lesson-polish";
...
async function main() {
  ...
  if (!units?.length) {
    console.error("Run seed-act-english.mjs first");
    process.exit(1);
  }
  ...
  console.log("Done — https://sch00l.ai/study → ACT English & Reading");
}
