...
import {
  ...
  isPublisherLesson,
  type LessonRow,
} from "../src/lib/college-gen-chem-2-lesson-polish";
...
async function main() {
  ...
  if (!units?.length) {
    console.error("Run scripts/seed-college-gen-chem-2.mjs first");
    process.exit(1);
  }
  ...
  console.log("Done — https://sch00l.ai/study → General Chemistry II");
}
